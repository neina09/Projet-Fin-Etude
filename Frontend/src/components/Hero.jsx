...
const services = [
  { name: "Assembly",     icon: Wrench,   color: "group-hover:text-blue-400",   border: "hover:border-blue-400/40",   glow: "group-hover:bg-blue-400/10"   },
  { name: "Mounting",     icon: Hammer,   color: "group-hover:text-yellow-400", border: "hover:border-yellow-400/40", glow: "group-hover:bg-yellow-400/10" },
  { name: "Moving",       icon: Truck,    color: "group-hover:text-green-400",  border: "hover:border-green-400/40",  glow: "group-hover:bg-green-400/10"  },
  { name: "Cleaning",     icon: Brush,    color: "group-hover:text-pink-400",   border: "hover:border-pink-400/40",   glow: "group-hover:bg-pink-400/10"   },
  { name: "Outdoor",      icon: TreePine, color: "group-hover:text-teal-400",   border: "hover:border-teal-400/40",   glow: "group-hover:bg-teal-400/10"   },
  { name: "Home Repairs", icon: Home,     color: "group-hover:text-orange-400", border: "hover:border-orange-400/40", glow: "group-hover:bg-orange-400/10" },
  { name: "Repairing",    icon: Settings, color: "group-hover:text-purple-400", border: "hover:border-purple-400/40", glow: "group-hover:bg-purple-400/10" },
]
            ...
            return (
              ...
              >
                ...
                <span className="text-[11px] font-medium text-white/50
                  group-hover:text-white/90 transition-colors duration-300 leading-tight text-center">
                  {service.name}
                </span>
              </motion.div>
            )
